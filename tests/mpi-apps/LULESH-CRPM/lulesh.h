...
class Domain {
  ...
  //private:
   ...
   /* Node-centered */
   using VectorReal = std::vector<Real_t, crpm::Crpm2Allocator<Real_t>>;
   VectorReal m_x;  /* coordinates */
   VectorReal m_y;
   VectorReal m_z;

   VectorReal m_xd; /* velocities */
   VectorReal m_yd;
   VectorReal m_zd;

   VectorReal m_xdd; /* accelerations */
   VectorReal m_ydd;
   VectorReal m_zdd;

   VectorReal m_fx;  /* forces */
   VectorReal m_fy;
   VectorReal m_fz;

   VectorReal m_nodalMass;  /* mass */

   using VectorIndex = std::vector<Index_t, crpm::Crpm2Allocator<Index_t>>;
   using VectorInt = std::vector<Int_t, crpm::Crpm2Allocator<Int_t>>;

   VectorIndex m_symmX;  /* symmetry plane nodesets */
   VectorIndex m_symmY;
   VectorIndex m_symmZ;
   ...
   VectorIndex m_nodelist;     /* elemToNode connectivity */

   VectorIndex m_lxim;  /* element connectivity across each face */
   VectorIndex m_lxip;
   VectorIndex m_letam;
   VectorIndex m_letap;
   VectorIndex m_lzetam;
   VectorIndex m_lzetap;

   VectorInt m_elemBC;  /* symmetry/free-surface flags for each elem face */

   VectorReal m_dxx;  /* principal strains -- temporary */
   VectorReal m_dyy;
   VectorReal m_dzz;

   VectorReal m_delv_xi;    /* velocity gradient -- temporary */
   VectorReal m_delv_eta;
   VectorReal m_delv_zeta;

   VectorReal m_delx_xi;    /* coordinate gradient -- temporary */
   VectorReal m_delx_eta;
   VectorReal m_delx_zeta;

   VectorReal m_e;   /* energy */

   VectorReal m_p;   /* pressure */
   VectorReal m_q;   /* q */
   VectorReal m_ql;  /* linear term for q */
   VectorReal m_qq;  /* quadratic term for q */

   VectorReal m_v;     /* relative volume */
   VectorReal m_volo;  /* reference volume */
   VectorReal m_vnew;  /* new relative volume -- temporary */
   VectorReal m_delv;  /* m_vnew - m_v */
   VectorReal m_vdov;  /* volume derivative over volume */

   VectorReal m_arealg;  /* characteristic length of an element */

   VectorReal m_ss;      /* "sound speed" */

   VectorReal m_elemMass;  /* mass */
